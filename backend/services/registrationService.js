...
const sendVerificationEmail = async (user, verificationToken) => {
    ...
    const subject = 'Welcome to Todo - Verify your email';

    const text = `Welcome to Todo!

Thank you for registering. To complete your registration and start using Todo, please verify your email address by clicking the link below:
...
If you didn't create an account with Todo, you can safely ignore this email.
...
<p>Thank you for registering. To complete your registration and start using Todo, please verify your email address by clicking the button below:</p>
...
<p>If you didn't create an account with Todo, you can safely ignore this email.</p>
