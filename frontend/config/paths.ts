...
declare global {
    interface Window {
        __TODO_BASE_PATH__?: string;
    }
}

const envBasePath = process.env.TODO_BASE_PATH || '';
...
const runtimeBasePath = (() => {
    ...
    if (typeof window.__TODO_BASE_PATH__ === 'string') {
        return sanitizeBasePath(window.__TODO_BASE_PATH__);
    }
